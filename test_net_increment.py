...
def parse_args():
  ...
  parser.add_argument('--save', dest='save',
                      ...
                      default='',
                      type=str)
  parser.add_argument('--ngt', dest='ngt',
                      help='save gt feature/test fea',
                      action='store_true')
  parser.add_argument('--testgt', dest='testgt',
                      help='test extra classifier using gt roi ',
                      action='store_true')
...
if __name__ == '__main__':
  ...
  elif args.dataset == "pascal_voc_test_sqe_11_12":
      args.imdb_name = "voc_2007_trainval+voc_2012_trainval"
      args.imdbval_name = "voc_2007_test_sqe_table_dog"
      args.set_cfgs = ['ANCHOR_SCALES', '[8, 16, 32]', 'ANCHOR_RATIOS', '[0.5,1,2]']
      args.imdb_name_org = 'voc_2007_10_train'
  elif args.dataset == "pascal_voc_test_sqe_13_14":
      args.imdb_name = "voc_2007_trainval+voc_2012_trainval"
      args.imdbval_name = "voc_2007_test_sqe_horse_bike"
      args.set_cfgs = ['ANCHOR_SCALES', '[8, 16, 32]', 'ANCHOR_RATIOS', '[0.5,1,2]']
      args.imdb_name_org = 'voc_2007_11_12_table_dog'
  elif args.dataset == "pascal_voc_test_sqe_15_16":
      args.imdb_name = "voc_2007_trainval+voc_2012_trainval"
      args.imdbval_name = "voc_2007_test_sqe_person_plant"
      args.set_cfgs = ['ANCHOR_SCALES', '[8, 16, 32]', 'ANCHOR_RATIOS', '[0.5,1,2]']
      args.imdb_name_org = 'voc_2007_13_14_horse_bike'
  elif args.dataset == "pascal_voc_test_sqe_17_18":
      args.imdb_name = "voc_2007_trainval+voc_2012_trainval"
      args.imdbval_name = "voc_2007_test_sqe_sheep_sofa"
      args.set_cfgs = ['ANCHOR_SCALES', '[8, 16, 32]', 'ANCHOR_RATIOS', '[0.5,1,2]']
      args.imdb_name_org = 'voc_2007_15_16_person_plant'
  elif args.dataset == "pascal_voc_test_sqe_19_20":
      args.imdb_name = "voc_2007_trainval+voc_2012_trainval"
      args.imdbval_name = "voc_2007_test_sqe_train_tv"
      args.set_cfgs = ['ANCHOR_SCALES', '[8, 16, 32]', 'ANCHOR_RATIOS', '[0.5,1,2]']
  ...
  elif args.dataset == "pascal_voc_test_sqe_da1":
      args.imdb_name = "voc_2007_trainval+voc_2012_trainval"
      args.imdbval_name = "voc_2007_test_5_da1"
      args.set_cfgs = ['ANCHOR_SCALES', '[8, 16, 32]', 'ANCHOR_RATIOS', '[0.5,1,2]']
      args.imdb_name_expert = "voc_2007_5_b"
      args.imdb_name_org = 'voc_2007_5_a'
  elif args.dataset == "pascal_voc_test_sqe_db1":
      args.imdb_name = "voc_2007_trainval+voc_2012_trainval"
      args.imdbval_name = "voc_2007_test_5_db1"
      args.set_cfgs = ['ANCHOR_SCALES', '[8, 16, 32]', 'ANCHOR_RATIOS', '[0.5,1,2]']
      args.imdb_name_expert = "voc_2007_5_b"
      args.imdb_name_org = 'voc_2007_5_a'
  elif args.dataset == "pascal_voc_test_sqe_dc1":
      args.imdb_name = "voc_2007_trainval+voc_2012_trainval"
      args.imdbval_name = "voc_2007_test_5_dc1"
      args.set_cfgs = ['ANCHOR_SCALES', '[8, 16, 32]', 'ANCHOR_RATIOS', '[0.5,1,2]']
      args.imdb_name_expert = "voc_2007_5_b"
      args.imdb_name_org = 'voc_2007_5_a'
  elif args.dataset == "pascal_voc_test_sqe_dd1":
      args.imdb_name = "voc_2007_trainval+voc_2012_trainval"
      args.imdbval_name = "voc_2007_test_5_dd1"
      args.set_cfgs = ['ANCHOR_SCALES', '[8, 16, 32]', 'ANCHOR_RATIOS', '[0.5,1,2]']
      args.imdb_name_expert = "voc_2007_5_b"
      args.imdb_name_org = 'voc_2007_5_a'
  ...
  elif args.dataset == "coco_test_b_2014":
      args.imdb_name = "coco_b_2014"
      args.imdbval_name = "coco_test_b_2014"
      args.set_cfgs = ['ANCHOR_SCALES', '[4, 8, 16, 32]', 'ANCHOR_RATIOS', '[0.5,1,2]']
      args.imdb_name_expert = "coco_b_expert_2014"
      args.imdb_name_org = 'coco_a_2014'
  elif args.dataset == "coco_test_c_2014":
      args.imdb_name = "coco_c_2014"
      args.imdbval_name = "coco_test_c_2014"
      args.set_cfgs = ['ANCHOR_SCALES', '[4, 8, 16, 32]', 'ANCHOR_RATIOS', '[0.5,1,2]']
      args.imdb_name_expert = "coco_c_expert_2014"
      args.imdb_name_org = 'coco_b_2014'
  elif args.dataset == "coco_test_d_2014":
      args.imdb_name = "coco_d_2014"
      args.imdbval_name = "coco_test_d_2014"
      args.set_cfgs = ['ANCHOR_SCALES', '[4, 8, 16, 32]', 'ANCHOR_RATIOS', '[0.5,1,2]']
      args.imdb_name_expert = "coco_d_expert_2014"
      args.imdb_name_org = 'coco_c_2014'
  elif args.dataset == "coco_1_test":
      args.imdb_name = "coco_1_train_inc"
      args.imdbval_name = "coco_1_test"
      args.set_cfgs = ['ANCHOR_SCALES', '[4, 8, 16, 32]', 'ANCHOR_RATIOS', '[0.5,1,2]']
      args.imdb_name_expert = "coco_b_expert"
      args.imdb_name_org = 'coco_40_train_base'
  elif args.dataset == "coco_2_test":
      args.imdb_name = "coco_2_train_inc"
      args.imdbval_name = "coco_2_test"
      args.set_cfgs = ['ANCHOR_SCALES', '[4, 8, 16, 32]', 'ANCHOR_RATIOS', '[0.5,1,2]']
      args.imdb_name_expert = "coco_b_expert"
      args.imdb_name_org = 'coco_40_train_base'
  elif args.dataset == "coco_4010_test":
      args.imdb_name = "coco_4010_train_inc"
      args.imdbval_name = "coco_4010_test"
      args.set_cfgs = ['ANCHOR_SCALES', '[4, 8, 16, 32]', 'ANCHOR_RATIOS', '[0.5,1,2]']
      args.imdb_name_expert = "coco_b_expert"
      args.imdb_name_org = 'coco_40_train_base'
  elif args.dataset == "coco_5_test":
      args.imdb_name = "coco_5_train_inc"
      args.imdbval_name = "coco_5_test"
      args.set_cfgs = ['ANCHOR_SCALES', '[4, 8, 16, 32]', 'ANCHOR_RATIOS', '[0.5,1,2]']
      args.imdb_name_expert = "coco_b_expert"
      args.imdb_name_org = 'coco_40_train_base'
  elif args.dataset == "coco_10_test":
      args.imdb_name = "coco_10_train_inc"
      args.imdbval_name = "coco_10_test"
      args.set_cfgs = ['ANCHOR_SCALES', '[4, 8, 16, 32]', 'ANCHOR_RATIOS', '[0.5,1,2]']
      args.imdb_name_expert = "coco_b_expert"
      args.imdb_name_org = 'coco_40_train_base'
  elif args.dataset == "coco_4020_test":
      args.imdb_name = "coco_4020_train_inc"
      args.imdbval_name = "coco_4020_test"
      args.set_cfgs = ['ANCHOR_SCALES', '[4, 8, 16, 32]', 'ANCHOR_RATIOS', '[0.5,1,2]']
      args.imdb_name_expert = "coco_b_expert"
      args.imdb_name_org = 'coco_40_train_base'
  elif args.dataset == 'cattv':
      args.imdb_name = 'voc_2007_1_inc_tv'
      args.imdb_name_org = 'voc_2007_1_train_cat'
      args.imdbval_name = 'voc_2007_1_test_cattv'
      args.set_cfgs = ['ANCHOR_SCALES', '[8, 16, 32]', 'ANCHOR_RATIOS', '[0.5,1,2]', 'MAX_NUM_GT_BOXES', '20']
  elif args.dataset == 'catdog':
      args.imdb_name = 'voc_2007_1_inc_dog'
      args.imdb_name_org = 'voc_2007_1_train_cat'
      args.imdbval_name = 'voc_2007_1_test_catdog'
      args.set_cfgs = ['ANCHOR_SCALES', '[8, 16, 32]', 'ANCHOR_RATIOS', '[0.5,1,2]', 'MAX_NUM_GT_BOXES', '20']
  ...
  if args.save:
      imdb, roidb, ratio_list, ratio_index = combined_roidb(args.imdb_name_expert, False)
  # if cfg.NEW_CLASSES==5 :#and '15' in args.dataset
  ...
  # imdb_org, roidb_org, ratio_list_org, ratio_index_org = combined_roidb(args.imdb_name_org, False)
  ...
  missing_keys, unexpected_keys = fasterRCNN.load_state_dict(frcnn_dict, strict=False)#(checkpoint['model'])
  ...
  if args.testgt:
      right = torch.zeros(imdb.num_classes).cuda()
      allgt = torch.zeros(imdb.num_classes).cuda()
  ...
  for i in range(num_images):
      ...
      if args.testgt:
          ex_cls, ex_rois_label = fasterRCNN(im_data, im_info, gt_boxes, num_boxes, fasterRCNN_residual=None,
                                               fasterRCNN_org=None, extract_gtfea=True if args.save else False, testgt=True if args.testgt else False)
          pred_l = torch.argmax(ex_cls, dim=1)
          # print(pred_l, ex_rois_label)
          for pl, rl in zip(pred_l, ex_rois_label):
              if pl+1 == rl:
                right[rl]+=1
              allgt[rl]+=1
          ...
          rois_label, pooled_feat = fasterRCNN(im_data, im_info, gt_boxes, num_boxes,fasterRCNN_residual=None,fasterRCNN_org=None, extract_gtfea=True if args.save else False)
      ...
      if args.save and not args.ngt:
          if args.save and pooled_feat_label.shape[0]==0 and rois_label is not None:
              pooled_feat_label = rois_label.to(torch.int32)-1#torch.Tensor([int(j)-1]).repeat(pooled_feat_t.shape[0]).to(torch.int32)
              pooled_feat_all = pooled_feat
          elif args.save and rois_label is not None:
              pooled_feat_label = torch.cat((pooled_feat_label, rois_label.to(torch.int32)-1),dim=0)
              pooled_feat_all = torch.cat((pooled_feat_all, pooled_feat),dim=0)
          print(pooled_feat_label.shape[0],pooled_feat_all.shape[0])
      ...
      for j in xrange(1, imdb.num_classes):
          ...
          if inds.numel() > 0:
            ...
            if vis:
              im2show = vis_detections(im2show, imdb.classes[j], cls_dets.cpu().numpy(), 0)#0.3
      ...
      if vis:
          if not os.path.exists('vis'):
              os.mkdir('vis')
          print('vis/'+imdb.image_path_at(i).split('/')[-1])
          cv2.imwrite('vis/'+imdb.image_path_at(i).split('/')[-1], im2show)
          #pdb.set_trace()
          #cv2.imshow('test', im2show)
          #cv2.waitKey(0)
  if args.save:
    torch.save(pooled_feat_all, 'cts_fea_'+args.save+'.pth')
    torch.save(pooled_feat_label, 'cts_label_'+args.save+'.pth')
  ...
  if args.testgt:
      print('extra classifier per-precision: {}'.format(right[:-1]/allgt[:-1]))
      print('extra classifier precision: {}'.format(sum(right[:-1])/sum(allgt[:-1])))

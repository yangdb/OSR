...
__C.TRAIN = edict()
__C.TRAIN.SET = 'voc'#'coco'#'voc'
__C.NEW_CLASSES = 1#40#40 #2 #2 #10#10#5#10#5 #############################number of new classes
__C.TRAIN.SQE = ['10','voc-11','voc-12','voc-13','voc-14','voc-15','voc-16','voc-17','voc-18','voc-19','voc-20']#['10','voc-1112']#['15','voc-16','voc-17','voc-18','voc-19','voc-20']#['5a', '5b', '5c','5d']
__C.TRAIN.SQE = ['2014_coco_a','2014_coco_b']#,'2014_coco_c','2014_coco_d']#
#__C.TRAIN.SQE = ['10','voc-1112','voc-1314','voc-1516','voc-1718','voc-1920']
#__C.TRAIN.SQE = ['15','voc-16','voc-17','voc-18','voc-19']#,'voc-20']
#__C.TRAIN.SQE = ['5a', '5b', '5c', '5d']
__C.TRAIN.SQE = None
__C.TRAIN.pdsllam = 5
__C.TRAIN.cdsllam = 1#10
...
#__C.TRAIN.CROP_PATH = ROOT_P+'CPR-IOD/faster-rcnn/data/2007_crops/19_5_new_pad/'#_pad/'
###### 2 ###############################
__C.TRAIN.GRAY_AUG = True
__C.TRAIN.GRAY_NUM = 10#200#5#20#25#50#10#10#1#5
__C.TRAIN.GRAY_RATIO = 0.5 #0.7 #0.5
if __C.NEW_CLASSES == 10 or __C.NEW_CLASSES == 20 or __C.NEW_CLASSES == 40:
    __C.TRAIN.GRAY_RATIO = 0.1#1#0.1
__C.TRAIN.BG = 'img' #'rand'#'rand'#'rand'#'patch','gray'
#__C.TRAIN.NEW_PATH = ROOT_P+'CPR-IOD/faster-rcnn/data/2007_crops/inc-5_5_new_pad/'#ROOT_P+'ydb/CPR-IOD/faster-rcnn/data/2007_crops/inc-tv_5_new_pad/'
...
#['10','voc-1112']#['15','voc-16','voc-17','voc-18','voc-19','voc-20']#['5a','5b']#['15','voc-16']#['10','voc-1112']#['10','voc-11']#,'voc-12']#,'voc-13']#['15','voc-16','voc-17','voc-18','voc-19','voc-20']#None #['10','voc-1112']['15','voc-16']['5a', '5b_5', '5c_5'] #None #['5a'] #None # ['5a'] #None ['5a', '5b_5']
if not __C.TRAIN.IM_AUG and not __C.TRAIN.BL:
    if __C.NEW_CLASSES==1:
        __C.TRAIN.CROP_PATH=ROOT_P+'CPR-IOD/faster-rcnn/data/2007_crops/19_'+str(s_num)+'_new_pad_resnormth/'#_pad/'
        __C.TRAIN.NEW_PATH = ROOT_P+'CPR-IOD/faster-rcnn/data/2007_crops/inc-tv_'+str(n_num)+'_new_pad/'
        __C.TRAIN.CROP_PATH = '/mnt/disk7/ydb/Object_train/CPR-IOD/faster-rcnn/data/imagenet_crops/ccc-1-resnormth-19/'#'/mnt/disk7/ydb/Object_train/CPR-IOD/faster-rcnn/data/imagenet_crops/ccc-19-1/'
        if __C.TRAIN.SQE is not None:
            __C.TRAIN.CROP_PATH=[]
            for sq in __C.TRAIN.SQE[:-1]:
                __C.TRAIN.CROP_PATH.append(ROOT_P+'CPR-IOD/faster-rcnn/data/2007_crops/vocgroup1/' + sq+'_' +str(s_num)+ '_new_pad_resnormth/')
        ...
        __C.TRAIN.CROP_PATH=ROOT_P+'CPR-IOD/faster-rcnn/data/2007_crops/15_'+str(s_num)+'_new_pad_resnormth/'#_pad/'
        #__C.TRAIN.CROP_PATH=ROOT_P+'CPR-IOD/faster-rcnn/crops/15_pad_min/'
        __C.TRAIN.CROP_PATH = '/mnt/disk7/ydb/Object_train/CPR-IOD/faster-rcnn/data/imagenet_crops/ccc-1-resnormth-15/'#'/mnt/disk7/ydb/Object_train/CPR-IOD/faster-rcnn/data/imagenet_crops/ccc-15-1/'
        __C.TRAIN.NEW_PATH = ROOT_P+'CPR-IOD/faster-rcnn/data/2007_crops/inc-5_'+str(n_num)+'_new_pad/'
        if __C.TRAIN.SQE is not None:
            __C.TRAIN.CROP_PATH=[]
            for sq in __C.TRAIN.SQE[:-1]:
                __C.TRAIN.CROP_PATH.append(ROOT_P+'CPR-IOD/faster-rcnn/data/2007_crops/vocgroup/' + sq+'_' +str(s_num)+ '_new_pad_resnormth/')
        ...
        __C.TRAIN.CROP_PATH=ROOT_P+'CPR-IOD/faster-rcnn/data/2007_crops/10_'+str(s_num)+'_new_pad_resnormth/'#_pad/'
        __C.TRAIN.CROP_PATH = '/mnt/disk7/ydb/Object_train/CPR-IOD/faster-rcnn/data/imagenet_crops/ccc-1-resnormth-10/'#'/mnt/disk7/ydb/Object_train/CPR-IOD/faster-rcnn/data/imagenet_crops/ccc-10-1/'
        __C.TRAIN.NEW_PATH = ROOT_P+'CPR-IOD/faster-rcnn/data/2007_crops/inc-10_'+str(n_num)+'_new_pad/'
    elif __C.NEW_CLASSES==2:
        if __C.TRAIN.SQE is not None:
            __C.TRAIN.CROP_PATH=[]
            for sq in __C.TRAIN.SQE[:-1]:
                __C.TRAIN.CROP_PATH.append(ROOT_P+'CPR-IOD/faster-rcnn/data/2007_crops/vocgroup2/' + sq+'_' +str(s_num)+ '_new_pad_resnormth/')
            __C.TRAIN.NEW_PATH = ROOT_P+'CPR-IOD/faster-rcnn/data/2007_crops/'+__C.TRAIN.SQE[-1]+'_'+str(n_num)+'_new_pad/'
    if __C.TRAIN.SET=='coco':
        if __C.NEW_CLASSES==40:
            n_num=50
            __C.TRAIN.CROP_PATH=ROOT_P+'CPR-IOD/faster-rcnn/data/2007_crops/2014_coco_40_'+str(s_num)+'_new_pad_resnormth/'#_pad/'
            ...
            if __C.TRAIN.SQE is not None:
                __C.TRAIN.CROP_PATH=[]
                for sq in __C.TRAIN.SQE[:-1]:
                    __C.TRAIN.CROP_PATH.append(ROOT_P+'CPR-IOD/faster-rcnn/data/2007_crops/cocogroup/' + sq+'_' +str(s_num)+ '_new_pad_resnormth/')
                __C.TRAIN.NEW_PATH = ROOT_P+'CPR-IOD/faster-rcnn/data/2007_crops/'+__C.TRAIN.SQE[-1]+'_'+str(n_num)+'_new_pad/'
            else:
...
elif __C.TRAIN.IM_AUG or __C.TRAIN.BL:
    __C.TRAIN.GRAY_AUG = False
    __C.TRAIN.CROP_AUG = False #None
    __C.TRAIN.CTS = False #True #False #True
    __C.TRAIN.Filter = False
    __C.TRAIN.mixobj = False
    __C.TRAIN.isda = False
    __C.TRAIN.excls = False
    __C.TRAIN.excp = False #False ## False:Copy RCNN_top True: New RCNN_top
    __C.TRAIN.pool = False

    #__C.TRAIN.CROP_PATH = None
    #__C.TRAIN.NEW_PATH = None
    __C.TRAIN.CROP_PATH=ROOT_P+'CPR-IOD/faster-rcnn/data/2007_crops/15_'+str(s_num)+'_new_pad_resnormth/'#_pad/'
    #__C.TRAIN.CROP_PATH=ROOT_P+'CPR-IOD/faster-rcnn/crops/15_pad_min/'
    __C.TRAIN.NEW_PATH = ROOT_P+'CPR-IOD/faster-rcnn/data/2007_crops/inc-5_'+str(n_num)+'_new_pad/'
...
__C.TRAIN.BASE_NUM = 1 #1 #0#1#2  #gray sample gt crop num (for new classes)
